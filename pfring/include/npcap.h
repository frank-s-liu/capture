/*
 *
 *  Copyright (C) 2012-2018 - ntop.org
 *
 */
...
npcap_extract_handle_t * npcap_extract_open(char *pcap_path, char *index_path, nbpf_tree_t *nbpf_filter, struct bpf_program *pcap_filter, u_int8_t enable_pcap_post_filter);
...
/* timeline extraction */
timeline_extract_handle_t *timeline_extract_open(char *timeline_path, time_t begin_epoch, time_t end_epoch, nbpf_tree_t *nbpf_filter, struct bpf_program *pcap_filter, u_int8_t enable_pcap_post_filter);
